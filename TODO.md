...
- [ ] **README を新構成に更新**（旧 game/menu 記述が残っている）
- [ ] **オーディオ拡張**：BGM(fileplayer) + シンセ、g_sound_on 連動
- [ ] **タイマー/トゥイーン**（イージング）
- [ ] **タイルマップ**簡易ステージ
- [ ] **会話ウィンドウ拡張**：選択肢分岐、立ち絵・名前ボックス、長文ページ送り
- [ ] 再利用リストUI部品（stage select / settings の選択リスト共通化）
